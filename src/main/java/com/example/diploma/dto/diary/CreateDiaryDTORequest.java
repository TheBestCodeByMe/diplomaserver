...
@NoArgsConstructor
@ToString
public class CreateDiaryDTORequest {
    ...
    public CreateDiaryDTORequest(String namePupil, String lastnamePupil, String patronymicPupil, String subject, String homework, String grade, boolean attendance, LocalDate dateLesson, String className) {
    ...
    public boolean equals(Object o) {
        ...
        CreateDiaryDTORequest createDiaryDTORequest = (CreateDiaryDTORequest) o;
